<div>
    ...
    <div style="padding-left: 20px !important;" class="pb-2" x-show="showPickUp" x-transition.duration.500ms>
        <h5>
            ...
            <small>(You selected: <span class="text-black-50 pickup-selected-address">-</span>)</small>
        </h5>
        <ol class="list-group">
            <li class="list-group-item align-items-start p-0 border-0">
                <div class="form-check">
                    <input class="form-check-input checkout-address" type="radio" name="available-pickup-location" onchange="highlightAddress(this, '.pickup-selected-address')">
                    <label class="form-check-label fw-normal">No 8 obasuyi crescent, Ijegun road, Ikotun, Lagos</label>
                </div>
            </li>
        </ol>
