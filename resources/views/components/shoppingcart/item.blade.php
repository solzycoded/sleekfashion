    ...
    <div class="card mb-3" style="max-width: 540px;">
      <div class="row g-0" x-data="{counter: {{ $quantity }}}">
        <div class="col-md-4">
          ...
          <img src="{{ $product->productImages[0]->image }}" class="img-fluid rounded-start" alt="shopping cart image" style="height: 100% !important; width: 100% !important">
        </div>
          ...
          <div class="card-body p-2">
            ...
            <div class="card-text mt-3">
              ...
              <div class="card-text mb-3 mt-2">
                  {{-- total --}}
                  <p class="card-text m-0">$<span x-text="(counter * {{ $productPrice }}).toLocaleString()"></span></p>
                  {{-- price * quantity --}}
